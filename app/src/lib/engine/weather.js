// @ts-nocheck
/* AUTO-GENERATED from planzo/services/weather.js — edit the source, then run scripts-port.mjs */
/**
...
export { forecast, outdoorPenalty, CODES };
export default { forecast, outdoorPenalty, CODES };